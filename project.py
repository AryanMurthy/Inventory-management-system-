...
# label entities
IM = Label(master=window, text="Inventory Management\t", fg="black", bg="white", relief=RAISED, font=("calibry", 12))
IM.place(x=1, y=1)
...
prod_name = Label(master=window, text="Product Name:", fg="white", bg="grey", relief=FLAT, font=("calibry", 8))
prod_name.place(x=1, y=110)
pro_name = Entry(window, textvar=Product_name)
pro_name.place(x=2, y=140)

sell_price = Label(master=window, text="Selling Price:", fg="white", bg="grey", relief=FLAT, font=("calibry", 8))
sell_price.place(x=1, y=180)
sp = Entry(window, textvar=Selling_price)
sp.place(x=2, y=210)
quant = Label(master=window, text="Quantity:", fg="white", bg="grey", relief=FLAT, font=("calibry", 8))
...
nameid = Label(master=window, text="Name:\t", fg="white", bg="grey", relief=FLAT, font=("calibry", 8))
nameid.place(x=410, y=40)

spid = Label(master=window, text="Selling Price:\t", fg="white", bg="grey", relief=FLAT, font=("calibry", 8))
spid.place(x=490, y=40)

quantid = Label(master=window, text="Quantity:\t", fg="white", bg="grey", relief=FLAT, font=("calibry", 8))
